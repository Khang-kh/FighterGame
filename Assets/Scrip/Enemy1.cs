...
public class Enemy1 : MonoBehaviour
{
    ...
    // Biến cho hiệu ứng nghiêng máy bay
    ...
    void Start()
    {
        ...
        StartCoroutine(MoveEnemy1ToRandomPoint());
    }
    ...
    {
        health -= damage;
        Debug.Log("Enemy1 bị sát thương, máu còn lại: " + health);
        if (health <= 0)
        {
            Debug.Log("Enemy1 bị tiêu diệt!");
            if (CoinPrefab != null)
            {
            ...
            {
                WaveManager.Instance.EnemyDefeated("Enemy1");
            }
            Destroy(gameObject);
        }
    }
    ...
    IEnumerator MoveEnemy1ToRandomPoint()
    {
        while (true)
        {
